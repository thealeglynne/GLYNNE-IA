...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: 'Automatizacion', path: '/automatizacion' },
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-[9999] px-4 md:px-6 py-2 flex items-center justify-between transition-all duration-300 ${
