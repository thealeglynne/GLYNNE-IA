    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center text-center space-y-6 bg-white/70 backdrop-blur-xl p-6 sm:p-10 ring-1 ring-black/10 shadow-xl rounded-3xl">
        <h2 className="text-xl md:text-3xl font-bold text-gray-900">
          Descubre qué puede automatizar tu empresa hoy
        </h2>
        ...
        <div className="flex flex-col space-y-4 text-gray-700 text-sm md:text-base leading-relaxed font-inter max-w-3xl">
          ...
          <p className="font-medium">
            Tu empresa tiene cientos de procesos que consumen tiempo, generan errores y frenan el crecimiento. Pero ahora, puedes rediseñarlos con IA.
          </p>

          <p className="font-semibold">
            <span className="text-black font-bold">GLY-IA</span> analiza tu operación actual y te muestra, en segundos, qué partes pueden ser automatizadas con inteligencia artificial, modelos LLM y flujos autónomos.
          </p>

          <p className="text-base font-semibold text-black">
            Diagnóstico rápido. Impacto real. Sin compromisos. Descubre el potencial oculto de tu operación hoy mismo.
          </p>
        </div>
        ...
        <button
          ...
          className="relative z-20 mt-6 px-10 py-4 text-base font-semibold bg-black text-white shadow-xl overflow-hidden rounded-xl group transition-all duration-300"
        >
