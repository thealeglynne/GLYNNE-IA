...
export default function MainGlyIAIntro() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0  backdrop-blur-[5.7px] z-0" />

      {/* Contenedor con imagen de fondo */}
      <div
        className="relative z-10 w-full max-w-5xl rounded-3xl p-6 sm:p-10 text-center flex flex-col items-center justify-center space-y-6 shadow-xl ring-1 ring-black/10 overflow-hidden"
        style={{
          backgroundImage: "url('/background-container.jpg')", // <-- imagen solo para el contenedor
          backgroundSize: 'cover',
          backgroundPosition: 'center',
        }}
      >
        {/* Capa blanca semi-transparente para que el texto sea legible */}
        <div className="absolute inset-0 bg-white/100 backdrop-blur-sm h-300 z-0" />
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-700 text-sm md:text-base leading-relaxed font-medium max-w-3xl mx-auto">
