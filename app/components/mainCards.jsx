  ...
  return (
    <section className="w-full min-h-screen text-black px-4 py-20 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-2 max-w-7xl mx-auto">
        {/* Card 1 */}
        <div
          className="relative md:col-span-3 text-white h-[350px] bg-cover bg-center shadow-md hover:scale-[1.01] transition-all duration-300"
        ...
        >
          <div className="absolute inset-0 bg-black/60 p-8 flex flex-col justify-end">
            ...
            <button className="text-sm font-medium underline">Ver más →</button>
          </div>
        </div>
        ...
        {/* Card 3 */}
        <div
          className="relative md:col-span-2 text-white h-[300px] bg-cover bg-center shadow-md hover:scale-[1.01] transition-all duration-300"
